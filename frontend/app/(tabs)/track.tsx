...
const TrackSpending = () => {
  ...
  // Use temporary static data for the Pie Chart
  ...
  // The fetchPieData function is commented out for now since we're using temporary data.
  /*
  ...
  */
  ...
  const handleAddSpending = async () => {
    ...
    // Commented out POST request for now
    /*
    try {
      const response = await fetch(
    ...
    */
    ...
    setSpendingNote("");
    setModalVisible(false);
    // Note: The pie chart remains static with the temporary data
  };
